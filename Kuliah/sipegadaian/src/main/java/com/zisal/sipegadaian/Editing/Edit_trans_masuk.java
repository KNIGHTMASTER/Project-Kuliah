 ...
 * @author zisal
 */
public class Edit_trans_masuk extends javax.swing.JInternalFrame {

    /** Creates new form Edit_trans_masuk */
    public Edit_trans_masuk() {
        initComponents();
        showTable(getData());
    }
...
public JTable tblTran_masuk=null;
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtnoresi, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 40, -1));
        getContentPane().add(txtjumlah, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 180, 50, -1));
        ...
        getContentPane().add(txttotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 210, 105, -1));

        jLabel4.setText("TGL TRANSAKSI :");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, -1, -1));
        ...
        getContentPane().add(btdelete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, 80, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 110, 410, 210));

        jLabel10.setFont(new java.awt.Font("DejaVu Sans", 1, 13));
        jLabel10.setForeground(new java.awt.Color(25, 13, 13));
        jLabel10.setText("Cari Berdasarkan No Resi :");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 90, -1, -1));
        getContentPane().add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 120, -1));
        ...
        getContentPane().add(BTUPDATE, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 100, 30));
        ...
        getContentPane().add(btcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 90, 70, 20));
        ...
        getContentPane().add(btdelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 100, 30));
        getContentPane().add(txttgl, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 110, -1));
        ...
        getContentPane().add(btcekID, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, -1, 20));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/TRANSAKSI MASUK.png"))); // NOI18N
...
private Object [][] getDataCari(){
    ...
    try{
        ...
        conn=(Connection) DriverManager.getConnection("jdbc:mysql://localhost/pegadaian?;","root","");
        st= (Statement) conn.createStatement();
        String query="SELECT * FROM tran_masuk WHERE no_resi LIKE ('%"+txtcari.getText()+"%');";
        rs=st.executeQuery(query);
        rs.last();
        int row=rs.getRow();
        rs.beforeFirst();
...
public void showTable(Object[][] data){
    ...
    tblTran_masuk=new JTable(data, col_names);
...
try{
        ...
        String query="update tran_masuk set jumlah=?, total=? , tgl_transaksi=? where no_resi=?";
        ...
        if(ok>0){
            JOptionPane.showMessageDialog(this, "Edit data Transaksi Masuk sukses","Informasi",JOptionPane.INFORMATION_MESSAGE);
            showTable(getData());
        }
        else{
            JOptionPane.showMessageDialog(this, "Edit data Transaksi Masuk gagal","Informasi",JOptionPane.INFORMATION_MESSAGE);
            showTable(getData());
        }
        ps.close();
        isClear();
...
void isClear(){
    ...
    private void btdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btdeleteActionPerformed
        ...
        if(konfirmasi==JOptionPane.YES_OPTION){
            String idbarang=tblTran_masuk.getValueAt(tblTran_masuk.getSelectedRow(),0).toString();
            try{
                konek.konek();
                PreparedStatement ps=null;
...
txtcari.requestFocus();
    ...
    private void btcekIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btcekIDActionPerformed
        ...
        try{
            ...
            rs=st.executeQuery("SELECT * FROM tran_masuk WHERE '"+txtnoresi.getText()+"';");
